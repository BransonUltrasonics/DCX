// $Header:   D:/databases/VMdb/archives/DCX/DCP/DCP Application/CyGOS/API/SPI.h_v   1.3   05 Mar 2013 06:35:02   amaurya  $
//
...
public:
	...
	virtual void LongWordTransfer(int length, uint8 * data, int maxLength,
			int chipSelect) = 0;
	virtual uint32 SetDelayParams(int pcssck, int pasc, int pdt, int cssck,
			int asc, int dt){
	   return 0;
	}
