// $Header:   D:/databases/VMdb/archives/DCX/DCP/DCP Application/CyGOS/API/TCPIP.cpp_v   1.2.1.2   02 Aug 2011 07:16:10   pdwivedi  $
//
...
void CyGOS::AddTcpInterface(int intf, int & priority, unsigned char * macAddr)
{
	...
	FEC * fec = new FEC(intf, mii, Board::rmii, macAddr);
	Ethernet * ethernet = new Ethernet(fec);
