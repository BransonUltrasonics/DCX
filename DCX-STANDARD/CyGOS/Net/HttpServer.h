// $Header:   D:/databases/VMdb/archives/DCX/DCP/DCP Application/CyGOS/Net/HttpServer.h_v   1.6   23 Aug 2012 11:32:28   amaurya  $
//
...
#define MODIFIED_SINCE_STR "Mon, 18 Jun 2011 13:24:51 GMT"
enum 
{
	texthtml,
	textcss,
...
typedef bool (*uploadHandler)(char * data, int dataLen, char *ext);
...
public:
	...
	bool HandlePostEvent(char * postData, char * uri,  HTTPReplyHeader & header);
	bool HandleGetEvent(char * uri, HTTPReplyHeader & header);
	bool HandleFileUpload(char * data, int dataLen, char *fileName);
