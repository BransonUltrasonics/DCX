// $Header:   D:/databases/VMdb/archives/DCX/DCP/DCP Application/CyGOS/stdlib/Alloc.cpp_v   1.2.1.0   28 Mar 2012 10:59:28   PDwivedi  $
//
...
#define SAFETY_BEGIN	0x100
#define SAFETY_END 		0x100
...
{
	return Malloc(size, file, line, true);
}
...
{
	return Malloc(size, "Unknown", 0, true);
}
...
{
	return Malloc(size, "malloc", 0, true);
}
