// $Header:   D:/databases/VMdb/archives/DCX/DCP/DCP Application/CyGOS/Arch/MCF/MCF5445x/CpuDefs.h_v   1.1   Jan 25 2016 09:58:20   Builder  $
//
...
#define MCF_PAD_PAR_TMR                    (*(vuint8 *)(0xFC0A4066))
...
/* Bit definitions and macros for MCF_PAD_PAR_TMR */
#define MCF_PAD_PAR_TMR_PAR_T0IN(x)        (((x)&0x3)<<0)
#define MCF_PAD_PAR_TMR_PAR_T0IN_GPIO      (0)
#define MCF_PAD_PAR_TMR_PAR_T0IN_U2RTS     (0x1)
#define MCF_PAD_PAR_TMR_PAR_T0IN_T0OUT     (0x2)
#define MCF_PAD_PAR_TMR_PAR_T0IN_T0IN      (0x3)
#define MCF_PAD_PAR_TMR_PAR_T1IN(x)        (((x)&0x3)<<0x2)
#define MCF_PAD_PAR_TMR_PAR_T1IN_GPIO      (0)
#define MCF_PAD_PAR_TMR_PAR_T1IN_U2CTS     (0x4)
#define MCF_PAD_PAR_TMR_PAR_T1IN_T1OUT     (0x8)
#define MCF_PAD_PAR_TMR_PAR_T1IN_T1IN      (0xC)
#define MCF_PAD_PAR_TMR_PAR_T2IN(x)        (((x)&0x3)<<0x4)
#define MCF_PAD_PAR_TMR_PAR_T2IN_GPIO      (0)
#define MCF_PAD_PAR_TMR_PAR_T2IN_U2TXD     (0x10)
#define MCF_PAD_PAR_TMR_PAR_T2IN_T2OUT     (0x20)
#define MCF_PAD_PAR_TMR_PAR_T2IN_T2IN      (0x30)
#define MCF_PAD_PAR_TMR_PAR_T3IN(x)        (((x)&0x3)<<0x6)
#define MCF_PAD_PAR_TMR_PAR_T3IN_GPIO      (0)
#define MCF_PAD_PAR_TMR_PAR_T3IN_U2RXD     (0x40)
#define MCF_PAD_PAR_TMR_PAR_T3IN_T3OUT     (0x80)
#define MCF_PAD_PAR_TMR_PAR_T3IN_T3IN      (0xC0)
