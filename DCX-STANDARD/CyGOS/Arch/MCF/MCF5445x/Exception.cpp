// $Header:   D:/databases/VMdb/archives/DCX/DCP/DCP Application/CyGOS/Arch/MCF/MCF5445x/Exception.cpp_v   1.4   05 Aug 2011 10:19:02   pdwivedi  $
//
...
void Exception::FirstHandler(void * frame)
{
	...
	if (RTOS::IntNesting() != 0)
	{
		...
		pprintf("\n\n\n");
		Log::WriteEventLog(FAULT_ERROR, (UINT16)oldLevel , MCF5XXX_RD_SF_VECTOR(frame), 1, true);
		ASSERT(0);
	}
	RTOS::IntNesting(+1);
...
void Exception::DefaultHandler(int vector, void * frame)
{
	...
	case 2:
		...
		Log::WriteEventLog(FAULT_ERROR, (unsigned short)MCF5XXX_RD_SF_FS(frame) , (unsigned short)MCF5XXX_SF_PC(frame), vector, true);
		Log::WriteEventLog(FAULT_ERROR, (unsigned short)(MCF5XXX_SF_PC(frame) >> 16) , (unsigned short)MCF5XXX_SF_PC(frame), vector, true);
	...
	case 30:
	case 31:
		Log::WriteEventLog(FAULT_ERROR, (unsigned short)(MCF5XXX_RD_SF_VECTOR(frame) - 24) , 0, vector, true);
	...
	case 46:
	case 47:
		Log::WriteEventLog(FAULT_ERROR, (unsigned short)(MCF5XXX_RD_SF_VECTOR(frame) - 32) , 0, vector, true);
	...
	case 62:
	case 63:
		Log::WriteEventLog(FAULT_ERROR, (unsigned short)(MCF5XXX_RD_SF_VECTOR(frame)) , 0, vector, true);
		pprintf("Reserved: #%d\n", MCF5XXX_RD_SF_VECTOR(frame));
		break;
	...
	case 71: // Eport Interrupt 7
		...
		Log::WriteEventLog(FAULT_ERROR, (unsigned short)(MCF_EPORT_EPFR) , 0, vector, true);
