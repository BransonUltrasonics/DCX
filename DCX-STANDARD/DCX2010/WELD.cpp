/*
$Header:   D:/databases/VMdb/archives/DCX/DCP/DCP Application/DCX2010/WELD.cpp_v   1.16.1.4   05 Jun 2014 11:04:42   amaurya  $
*/
/****************************************************************************/
/*                                                                          */
/*                                                                          */
 ...
 * 
 *    Rev 1.16.1.4   05 Jun 2014 11:04:42   amaurya
 * Fixed DEF00692
 * 
 *    Rev 1.16.1.3   01 May 2014 10:54:12   amaurya
 * Removed TuneFreq
 * 
 *    Rev 1.16.1.2   30 Apr 2014 06:20:48   amaurya
 * Added change for Digital Tune
 * 
 *    Rev 1.16.1.1   19 Oct 2013 06:34:48   rjamloki
 * Memory issue fixed.
 * 
 *    Rev 1.16.1.0   09 Sep 2013 08:59:58   rjamloki
   ...
   WeldError = Control(WELDFUNCTION);
	...
	if (WeldError)
	{
				...
				&& !(WebSite::CheckForWebTestCommand()))
		{
			...
			{
				/*store at weldend, and store the memory freq,only if external start*/
				//MemoryValue = DDSFrequency - Midband;
				MemoryValue = DDSFrequency - RunningPreset.DigitalTune;
				CurrentPreset.MemoryFreq = WeldMemoryFrequency;
				SavePreset(0);
			}
...
/******************************************************************************/
{
	...
	FrequencyValue = IntegralValue + FreqOffsetInputAtWeldStart;
	DDSFrequency = FrequencyValue + Midband;
	WeldStartFrequency = DDSFrequency;
	...
	if (RunningPreset.SWDip.Flags.ExtAmplitude)
		...
		WeldAmplitudeLimit = (RunningPreset.WeldAmplitude * ADC11BITVALUE) / SCALING_FACTOR;//don't use macro here
	RampDown = FALSE;
