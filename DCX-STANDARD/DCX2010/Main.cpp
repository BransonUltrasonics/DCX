/*
$Header:   D:/databases/VMdb/archives/DCX/DCP/DCP Application/DCX2010/Main.cpp_v   1.24.2.3   20 Jul 2015 15:48:32   GButron  $
*/
/****************************************************************************/
/*                                                                          */
/*                                                                          */
 ...
 * 
 *    Rev 1.24.2.3   20 Jul 2015 15:48:32   GButron
 * Stop feeding the Watchdog if the reason is software reset or software watchdog reset.
 * 
 *    Rev 1.24.2.2   04 Jul 2014 14:16:02   gbutron
 * Official Release V4.0
 * 
 *    Rev 1.24.2.1   09 Sep 2013 08:59:52   rjamloki
 * Added Seek Frequency Offset, Amplitude ramping, set all graph defaults as in WC.
 * 
 *    Rev 1.24.2.0   09 Oct 2012 09:58:44   ygupta
 * Fixed Scaling Issue.
 * 
...
//	printf("\n\n\n\nBuild Date: %s %s\n\n", buildDate, buildTime);
	CyGOS::Init();
	if(((MCF_RCM_RSR & MCF_RCM_RSR_SOFT) || (MCF_RCM_RSR & MCF_RCM_RSR_WDRCORE))!=0) // Stop feeding the Watchdog if the reason is software reset or software watchdog reset.
	   MCF_DTIM_DTMR(1) &= ~MCF_DTIM_DTMR_RST;   //This will disable Timer 1
