/*
$Header:   D:/databases/VMdb/archives/DCX/DCP/DCP Application/DCX2010/SEEK.cpp_v   1.8.1.5.2.3   01 May 2014 10:53:20   amaurya  $
*/
/****************************************************************************/
/*                                                                          */
/*                                                                          */
 ...
 * 
 *    Rev 1.8.1.5.2.3   01 May 2014 10:53:20   amaurya
 * Removed GlobalTuneFreq
 * 
 *    Rev 1.8.1.5.2.2   30 Apr 2014 06:19:32   amaurya
 * Added change for Digital Tune
 * 
 *    Rev 1.8.1.5.2.1   19 Oct 2013 06:34:46   rjamloki
 * Memory issue fixed.
 * 
 *    Rev 1.8.1.5.2.0   09 Sep 2013 08:59:54   rjamloki
...
/******************************************************************************/
{
   ...
   if((TestInputFlag && (!(UserIO::CheckForExternalTest())) && (!(LCDKeyStatus & KB_TEST)) && (!(WebSite::CheckForWebTestCommand())))||(SeekTimer >= SeekTime))
   {
...
/******************************************************************************/
{
	...
	else
	{
		...
		if(UserIO::CheckForExternalTest() || UserIO::CheckForExternalStart()|| (LCDKeyStatus & KB_TEST) || WebSite::CheckForWebTestCommand())
		{
			//Indicates not in seek mode
			UserIO::SetSeekOut(FALSE);
			store_seek_memo();
