/*
$Header:   D:/databases/VMdb/archives/DCX/DCP/DCP Application/DCX2010/InputTask.cpp_v   1.23.1.2   13 Jun 2014 08:44:22   amaurya  $
*/
/****************************************************************************/
/*                                                                          */
/*                                                                          */
 ...
 * 
 *    Rev 1.23.1.2   13 Jun 2014 08:44:22   amaurya
 * Added case v to print ADC value.
 * 
 *    Rev 1.23.1.1   23 May 2014 09:54:12   amaurya
 * Moved extern FreqOutDacVal to top.
 * 
 *    Rev 1.23.1.0   01 May 2014 10:52:46   amaurya
 * Added printf for DacOutValue
 * 
	...
	for (;;)
	{
		...
		//            CPU::Restart();
				 ...
				 case '5':
					...
					pprintf("\n FreqOutDacVal %d DDSfreq %d", FreqOutDacVal, DDSFrequency);
					break;
				 case '7':
				 ...
				 case 'U':
					 ...
					 break;
				 case 'v':
					 pprintf("\n Phs = %d\t Amp = %d,\t Curr = %d,\t Pwr = %d,\t Temp = %d",PhaseInput,ActualAmplitude,CurrentInput,PowerInput,InputTemperature);
					 break;
				 case 'V':
