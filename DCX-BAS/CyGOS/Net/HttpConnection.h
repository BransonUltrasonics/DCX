// $Header:   D:/databases/VMdb/archives/DCX/Weld Controller/WC/CyGOS/Net/HttpConnection.h_v   1.6   30 Aug 2013 15:04:46   amaurya  $
//
...
#define ERR_STR_FILEUPLOADED 	"<HTML><head><title>BRANSON DCX GUI</title></head>" \
