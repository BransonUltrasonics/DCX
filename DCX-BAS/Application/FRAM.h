/*
$Header:   D:/databases/VMdb/archives/DCX/Weld Controller/Application/FRAM.h_v   1.4   02 Sep 2016 11:55:46   EGUAJARDO  $
*/
/****************************************************************************/
/*                                                                          */
/*                                                                          */
...
/*************************                         **************************/
/*****************************************************************************
$Log:   D:/databases/VMdb/archives/DCX/Weld Controller/Application/FRAM.h_v  $
 * 
 *    Rev 1.4   02 Sep 2016 11:55:46   EGUAJARDO
 * Updated FRAM Version to 3.
 * 
 *    Rev 1.3   29 Jul 2015 07:53:52   RJamloki
 * Fram version changed to 2
 * 
 *    Rev 1.2   08 Aug 2014 11:21:56   rjamloki
 * Removed InitFramPointer function.
 * 
 *    Rev 1.1   13 Mar 2014 15:54:26   rjamloki
 * FRAM is accessed through pointers. Removed compiler allocation of FRAM
 * 
 *    Rev 1.0   04 Mar 2014 08:07:44   rjamloki
 * Initial revision.
 */
#ifndef FRAM_H_
#define FRAM_H_
...
#define FRAM_VERSION						3			//to be changed with structure format
#define FRAM_START_ADDRESS					0x0b000000
#define FRAM_BOOTLOADER_RESERVED			0x10 // first 16 bytes are reserved for bootloader
