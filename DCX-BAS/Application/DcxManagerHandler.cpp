/*
 $Header:   D:/databases/VMdb/archives/DCX/Weld Controller/Application/DcxManagerHandler.cpp_v   1.15   13 Mar 2014 15:53:54   rjamloki  $
 */
/****************************************************************************/
/*                                                                          */
/*                                                                          */
...
/*************************                         **************************/
/*****************************************************************************
 $Log:   D:/databases/VMdb/archives/DCX/Weld Controller/Application/DcxManagerHandler.cpp_v  $
 * 
 *    Rev 1.15   13 Mar 2014 15:53:54   rjamloki
 * FRAM is accessed through pointers. Removed compiler allocation of FRAM
 * 
 *    Rev 1.14   25 Oct 2013 11:59:12   ygupta
 ...
 * 
 *    Rev 1.13   15 Oct 2013 07:42:10   rjamloki
 * Tracker Fix, JSON Fix, Link Status debouncing configurable from Adv R&D page.
 * 
 *    Rev 1.12   08 Oct 2013 07:39:40   rjamloki
 * Fixed warnings.
 * 
 *    Rev 1.11   20 Sep 2013 07:00:10   rjamloki
 * Added changes to build bootloader with same CyGOS.
 * 
 *    Rev 1.10   17 Sep 2013 04:14:00   rjamloki
 * Added Task Manager again and reduced time for WatchDogTimer.
 * 
 *    Rev 1.9   03 Sep 2013 12:32:26   ygupta
 * Moved to tip from 1.7.1.1
 * 
 *    Rev 1.7.1.1   03 Sep 2013 11:14:06   amaurya
 * Tracker fixes and Synchronization fixes for User Outputs.
 * 
 *    Rev 1.7.1.0   24 Aug 2013 17:13:58   amaurya
 * Code review and tracker issue fixes.
 * 
 *    Rev 1.7   02 Aug 2013 10:55:44   amaurya
 * Coverty fixes.
 * 
 *    Rev 1.6   10 Jul 2013 07:49:20   amaurya
 * Fixed powerup DCP Event Log issue.
 * 
 *    Rev 1.5   08 Jul 2013 08:52:14   amaurya
 * Fixed tracker issue for Ver3.0y.
 * 
 *    Rev 1.4   27 Jun 2013 05:53:30   amaurya
 * System crash fixes.
 * 
 *    Rev 1.3   14 Jun 2013 11:21:06   amaurya
 * MH1 Round fixes
 * 
 *    Rev 1.2   28 May 2013 07:42:24   amaurya
 * Fixed issues of Level II testing.
 * 
 *    Rev 1.1   22 May 2013 10:41:36   ygupta
 * Fixes for Disable Stepping in while in after burst, energy braking and scrub time.
 * 
 *    Rev 1.0   21 May 2013 12:32:16   amaurya
 * Initial revision.
 */
...
SINT8 * DcxMangerHandler::JSONGetHandler(ip_addr PeerAddr, SINT8 * ServiceArgs)
{
	...
	if((PeerAddr.addr == ConnectedDcxmAddr.addr) && (ClearJSONObjects == FALSE)){
...
SINT8 * DcxMangerHandler::JSONSetHandler(ip_addr PeerAddr, SINT8 * JsonStr, SINT8 * ServiceArgs)
{
	SINT8 * ResPtr = Response;
	JsonStr = 0;
	ServiceArgs = 0;
