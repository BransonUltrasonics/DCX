/*
$Header:   D:/databases/VMdb/archives/DCX/Weld Controller/Application/EthernetIP.cpp_v   1.15   02 Sep 2016 12:15:06   EGUAJARDO  $
*/
/****************************************************************************/
/*                                                                          */
/*                                                                          */
...
/*************************                         **************************/
/*****************************************************************************
$Log:   D:/databases/VMdb/archives/DCX/Weld Controller/Application/EthernetIP.cpp_v  $
 * 
 *    Rev 1.15   02 Sep 2016 12:15:06   EGUAJARDO
 * Changed radio button to Test Amplitude mode from web page when test amplitude is changed via Ethernet IP.
 * 
 *    Rev 1.14   25 Aug 2014 10:10:04   amaurya
 * Added RegUpdateCmdFlag to update EtherNetIp register in Lcd
 * 
 *    Rev 1.13   13 Mar 2014 15:53:56   rjamloki
 * FRAM is accessed through pointers. Removed compiler allocation of FRAM
 * 
 *    Rev 1.12   13 Dec 2013 03:08:10   rjamloki
 ...
 * 
 *    Rev 1.11   13 Dec 2013 01:52:22   rjamloki
 * Forward Open Connection Size fix from 480 to 128.
 * 
 *    Rev 1.10   02 Dec 2013 07:34:18   rjamloki
 * Changes for EthIP Conformance Test.
 * 
 *    Rev 1.9   08 Oct 2013 06:17:38   rjamloki
 * Fixed warnings.
 * 
 *    Rev 1.8   03 Sep 2013 12:34:04   ygupta
 * Moved to tip from 1.6.1.5.1.0
 * 
 *    Rev 1.6.1.5.1.0   24 Aug 2013 17:13:58   amaurya
 * Code review and tracker issue fixes.
 * 
 *    Rev 1.6.1.5   02 Aug 2013 10:55:44   amaurya
 * Coverty fixes.
 * 
 *    Rev 1.6.1.4   21 May 2013 12:25:48   amaurya
 * Code review fixes.
 * 
 *    Rev 1.6.1.3   06 May 2013 09:14:44   amaurya
 * Changes to use actual frequency.
 * 
 *    Rev 1.6.1.2   26 Apr 2013 11:01:58   amaurya
 * Fixed traker issue for Ver2.0U.
 * 
 *    Rev 1.6.1.1   08 Apr 2013 08:21:32   amaurya
 * Fixed Tracker issue of Ver2.0P.
 * 
 *    Rev 1.6.1.0   20 Mar 2013 09:36:34   ygupta
 * RF Switch Changes, Requirement Changes
 * 
 *    Rev 1.7   20 Mar 2013 08:16:56   ygupta
 * RF Switch Changes, Requirement Changes
 * 
 *    Rev 1.6   11 Mar 2013 02:24:02   ygupta
 * Issues Fixed & Requirement Changes
 * 
 *    Rev 1.5   18 Feb 2013 03:04:36   ygupta
 * FieldBus Changes
 * 
 *    Rev 1.4   22 Jan 2013 10:38:08   ygupta
 * Profibus Bug Fixes
 * 
 *    Rev 1.3   16 Jan 2013 06:24:10   ygupta
...
#define TESTAMPSET_A_ETHIP_PARAM	1475
...
void EthernetIP::ProcessMailBox(CIFX_PACKET * MBXPkt)
{
	...
	if ((LE32_TO_HOST(MBXPkt->tHeader.ulCmd) & CIFX_MSK_PACKET_ANSWER) == 0) {
		...
		case EIP_OBJECT_CL3_SERVICE_IND:
			...
			memcpy(Cl3Res->tData.abData, Cl3Pkt->tData.abData , ServiceDataSize);
			Cl3Res->tHead.ulLen = HOST_TO_LE32(sizeof(EIP_OBJECT_CL3_SERVICE_RES_T) - MAX_SERVICEDATA_LEN + ServiceDataSize);
			Cl3Res->tData.ulAttribute = Cl3Pkt->tData.ulAttribute;
			Cl3Res->tData.ulConnectionId = Cl3Pkt->tData.ulConnectionId;
			Cl3Res->tData.ulGRC = HOST_TO_LE32(EthIPStat.GSC);
			Cl3Res->tData.ulERC = HOST_TO_LE32(EthIPStat.ESC);
			Cl3Res->tData.ulInstance = Cl3Pkt->tData.ulInstance;
			Cl3Res->tData.ulObject = Cl3Pkt->tData.ulObject;
			Cl3Res->tData.ulService = Cl3Pkt->tData.ulService;
      ...
      default:
         ...
         else if (Access == ACC_WRITE)
         {
            RetVal = WriteParamEthIP(AccessTokenStatus, Value, Len, InstanceNum, Attribute);
         	 if(RetVal.ESC == EXTSTAT_SUCCESS && RetVal.GSC == STAT_SUCCESS)
         	 {
         		 if(Attribute == TESTAMPSET_A_ETHIP_PARAM)
         		 {
