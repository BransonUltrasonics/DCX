/*
$Header:   D:/databases/VMdb/archives/DCX/Weld Controller/WC/Application/preset.h_v   1.32   Feb 08 2017 16:31:48   EGUAJARDO  $
*/
/****************************************************************************/
/*                                                                          */
/*                                                                          */
...
/*************************                         **************************/
/*****************************************************************************
$Log:   D:/databases/VMdb/archives/DCX/Weld Controller/WC/Application/preset.h_v  $
 * 
 *    Rev 1.32   Feb 08 2017 16:31:48   EGUAJARDO
 * Changed the size of WeldTime to UINT32.
 * 
 *    Rev 1.31   02 Sep 2016 11:50:28   EGUAJARDO
 * Added new TestSelection variable to the Horn specifications presets.
 * 
 *    Rev 1.30   29 Jul 2015 07:54:24   RJamloki
 * Added ClearMemoryFrequencyAtPowerup() function declaration
 * 
 *    Rev 1.29   21 Mar 2014 09:25:18   rjamloki
 * Tracker issue fixes.
 * 
 *    Rev 1.28   13 Mar 2014 15:54:56   rjamloki
 * FRAM is accessed through pointers. Removed compiler allocation of FRAM
 * 
 *    Rev 1.27   04 Mar 2014 07:49:24   rjamloki
 * Added Software Upgrade, Digital Tune and Memory Offset.
 * 
 *    Rev 1.26   06 Dec 2013 09:39:44   rjamloki
 * S and V loop constants incorporated.
 * 
 *    Rev 1.25   08 Oct 2013 06:17:32   rjamloki
 * Fixed warnings.
 * 
 *    Rev 1.24   03 Sep 2013 12:52:14   ygupta
 * Moved to tip from 1.22.1.11
 * 
 *    Rev 1.22.1.11   30 Aug 2013 15:01:34   amaurya
 * Fixed tracker issue 521,525,526,527,529,531.
 * 
 *    Rev 1.22.1.10   24 Aug 2013 17:14:08   amaurya
 * Code review and tracker issue fixes.
 * 
 *    Rev 1.22.1.9   08 Jul 2013 08:54:26   amaurya
 * Fixed tracker issue for Ver3.0y.
 * 
 *    Rev 1.22.1.8   14 Jun 2013 11:21:08   amaurya
 * MH1 Round fixes
 * 
 *    Rev 1.22.1.7   31 May 2013 10:37:16   amaurya
 * Level II testing fixes.
 * 
 *    Rev 1.22.1.6   28 May 2013 07:43:34   amaurya
 * Fixed issues of Level II testing.
 * 
 *    Rev 1.22.1.5   21 May 2013 12:25:56   amaurya
 * Code review fixes.
 * 
 *    Rev 1.22.1.4   06 May 2013 09:18:00   amaurya
 * Changes to use actual frequency.
 * 
 *    Rev 1.22.1.3   30 Apr 2013 11:19:54   amaurya
 * Changes related to State machine optimization.
 * 
 *    Rev 1.22.1.2   22 Apr 2013 11:31:44   amaurya
 * Fixed tracker issue of Ver2.0S
 * 
 *    Rev 1.22.1.1   08 Apr 2013 09:23:26   amaurya
 * Fixed Tracker issue of Ver2.0P.
 * 
 *    Rev 1.22.1.0   20 Mar 2013 09:38:06   ygupta
 * RF Switch Changes, Requirement Changes
 * 
 *    Rev 1.23   20 Mar 2013 08:18:12   ygupta
 * RF Switch Changes, Requirement Changes
 * 
 *    Rev 1.22   15 Mar 2013 10:51:22   ygupta
 * Issues Resolved, Requirement Changes
 * 
 *    Rev 1.21   11 Mar 2013 02:27:56   ygupta
 * Issues Fixed & Requirement Changes
 * 
 *    Rev 1.20   18 Feb 2013 03:09:08   ygupta
 * FieldBus Changes
 * 
 *    Rev 1.19   29 Jan 2013 02:21:30   ygupta
 * WebPages CleanUp, Code Review and CleanUp
 * 
 *    Rev 1.18   16 Jan 2013 06:28:02   ygupta
 * Level2 Code with Profibus
 * 
 *    Rev 1.17   11 Jan 2013 02:52:36   ygupta
 * Level2 Requirement Changes
 * 
 *    Rev 1.16   11 Jan 2013 01:51:24   ygupta
 * Stroke length and Amplitude Default Changed
 * 
 *    Rev 1.15   27 Dec 2012 06:44:42   ygupta
 * Changes to fix Issues
 * 
 *    Rev 1.14   18 Dec 2012 07:38:08   ygupta
 * Changes for Multiple Overload alarm in case of 15V lost
 * 
 *    Rev 1.13   13 Dec 2012 00:11:10   ygupta
 * Changes related to Issues
 * 
 *    Rev 1.12   29 Nov 2012 08:46:22   rjamloki
 * Scan Changes and Coverty issues Resolved
 * 
 *    Rev 1.11   24 Nov 2012 08:03:38   amaurya
 * Added changes for 40KHz supply.
 * 
 *    Rev 1.10   09 Nov 2012 00:34:58   rjamloki
 * State Machine and website changes
 * 
 *    Rev 1.9   05 Nov 2012 08:58:34   amaurya
 * State Machine changes
 * 
 *    Rev 1.8   29 Oct 2012 02:55:58   rjamloki
 * Printfs disbaled and changes in website
 * 
 *    Rev 1.7   26 Oct 2012 02:38:28   rjamloki
 * Website Related files Added
 * 
 *    Rev 1.6   21 Sep 2012 01:33:44   rjamloki
 * Added State machine
 * 
 *    Rev 1.5   11 Sep 2012 10:14:30   rjamloki
 * Added MAX_PRESETS define
 * 
 *    Rev 1.4   10 Sep 2012 03:12:30   rjamloki
 * Modbus changed implementation with unions and code cleanup
 * 
 *    Rev 1.3   29 Aug 2012 13:28:04   rjamloki
 * WC Modbus checkin and related changes
 * 
 *    Rev 1.2   05 Jul 2012 04:46:36   ygupta
 * Cleanup after review summary on database and BSP.
 * 
 *    Rev 1.1   29 Jun 2012 12:15:42   ygupta
 * First Compilable code, First check in after review, Needs more clanup
 * 
 *    Rev 1.0   21 Mar 2012 12:21:32   PDwivedi
 * Initial revision.
 *
 */
...
#define TEST_SELECTION_MIN 0
#define TEST_SELECTION_MAX 1
#define TEST_SELECTION_DEFAULT 0
...
enum AMPSTEP_COND
{
   ...
   AMPSTEP_COND_EXTERNALAIN,//fix on external amplitude
   AMPSTEP_COND_TIME,
   AMPSTEP_COND_ENERGY,
   AMPSTEP_COND_POWER,
...
typedef struct Hspreset
{
	...
	enum TESTAMP_COND TestSelection;
	UINT32 CRChsp;
}HSPRESET;

typedef struct HspresetV4
{
	//Seek parameters
	struct
	{
...
#define HSPSCRCDATA_SIZE (sizeof(HSPRESET) - sizeof(RunningHSPreset.CRChsp) \
				 - sizeof(RunningHSPreset.DigitalTuneScaledUP) - sizeof(RunningHSPreset.MemoryOffsetScaledUP)- sizeof(RunningHSPreset.TestSelection))
#endif
