/*
$Header:   D:/databases/VMdb/archives/DCX/Weld Controller/Application/workfiles/UserIO.h_v   1.28   08 Oct 2013 06:17:30   rjamloki  $
*/
/****************************************************************************/
/*                                                                          */
/*                                                                          */
...
/*************************                         **************************/
/*****************************************************************************
$Log:   D:/databases/VMdb/archives/DCX/Weld Controller/Application/workfiles/UserIO.h_v  $
 * 
...
#define	NUM_FUNC_OUT  55	 // # of output functions defined in PRS
...
//Maximum value of DAC output in millivolt to get the maximum required value of 10 Volt of analog outputs for the product.
   ...
   static SINT32 DigFilterMIAAin(SINT32 Element, ANALOG_INPUTS InputNumber);
	public://functions accessible by other modules.
	   static BOOLEAN CheckSignalActive(BOOLEAN Signal);
		...
		static void SetAmlitudeDecay(BOOLEAN State);
