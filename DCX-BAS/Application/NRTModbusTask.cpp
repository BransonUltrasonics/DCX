/*
$Header:   D:/databases/VMdb/archives/DCX/Weld Controller/Application/NRTModbusTask.cpp_v   1.21   Mar 08 2017 11:30:56   EGUAJARDO  $
*/
/****************************************************************************/
/*                                                                          */
/*                                                                          */
...
/*************************                         **************************/
/*****************************************************************************
$Log:   D:/databases/VMdb/archives/DCX/Weld Controller/Application/NRTModbusTask.cpp_v  $
 * 
 *    Rev 1.21   Mar 08 2017 11:30:56   EGUAJARDO
 * Modified the way to index DCPEventobj to order the events top to bottom on web page.
 * 
 *    Rev 1.20   Feb 08 2017 16:25:50   EGUAJARDO
                  ...
                  if(RepliedDataLen != ExpectedDataLen)
                     ...
                     switch(NrtQObj.Cmd){
                        ...
                        case CMD_GETEVENTLOG:
                           ...
                           ArrayIndex = ((DCPEventLogs - DCPEventIndex - 1) % MAX_DCP_EVENT_ENTRIES);
                           if(ArrayIndex >= 0)
                        	   memcpy(&DCPEventobj[ArrayIndex], NRTDatabuffer, sizeof(EventLog));
                           NRTResponse = REPLY_RECEIVED;
                        break;
                        case CMD_GETALARMLOG:
