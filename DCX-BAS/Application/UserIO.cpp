/*
$Header:   D:/databases/VMdb/archives/DCX/Weld Controller/Application/workfiles/UserIO.cpp_v   1.35   27 Mar 2014 13:00:02   hasanchez  $
*/
/****************************************************************************/
/*                                                                          */
/*                                                                          */
...
/*************************                         **************************/
/*****************************************************************************
$Log:   D:/databases/VMdb/archives/DCX/Weld Controller/Application/workfiles/UserIO.cpp_v  $
 * 
 *    Rev 1.35   27 Mar 2014 13:00:02   hasanchez
 * Changes of the tracker about Default Input/Output
 * 
 *    Rev 1.34   21 Mar 2014 09:26:34   rjamloki
 * Tracker issue fixes.
 * 
 *    Rev 1.32   10 Mar 2014 10:18:40   hasanchez
 * Some changes about the configurable inputs and outputs.
 * 
 *    Rev 1.30   15 Nov 2013 05:52:52   rjamloki
 * Export log fixes, Preready clearing the web command for statemachine, set up alarm implemented for invalid preset.
 * 
 *    Rev 1.29   14 Nov 2013 09:55:14   rjamloki
 * Tracker issue fixes.
 * 
 *    Rev 1.28   06 Nov 2013 06:20:32   rjamloki
 * Going to preready on user input configuration change to prevent sonics.
 * 
 *    Rev 1.27   08 Oct 2013 06:17:30   rjamloki
 * Fixed warnings.
 * 
 *    Rev 1.26   03 Sep 2013 18:12:08   ygupta
 * Moved to tip from 1.24.1.10.1.0
 * 
 *    Rev 1.24.1.10.1.0   24 Aug 2013 17:14:14   amaurya
 * Code review and tracker issue fixes.
 * 
 *    Rev 1.24.1.10   17 Jul 2013 06:22:10   amaurya
 * Fixed WeldTime Issue on History page and added diagnostic code.
 * 
 *    Rev 1.24.1.9   08 Jul 2013 08:55:40   amaurya
 * Fixed tracker issue for Ver3.0y.
 * 
 *    Rev 1.24.1.8   31 May 2013 10:37:18   amaurya
 * Level II testing fixes.
 * 
 *    Rev 1.24.1.7   24 May 2013 10:16:40   ygupta
 * Fixed Tracker Issue.
 * 
 *    Rev 1.24.1.6   22 May 2013 10:41:38   ygupta
 * Fixes for Disable Stepping in while in after burst, energy braking and scrub time.
 * 
 *    Rev 1.24.1.5   21 May 2013 12:26:02   amaurya
 * Code review fixes.
 * 
 *    Rev 1.24.1.4   07 May 2013 10:14:48   amaurya
 * Code review fixed.
 * 
 *    Rev 1.24.1.3   06 May 2013 09:20:20   amaurya
 * Changes to use actual frequency.
 * 
 *    Rev 1.24.1.2   30 Apr 2013 11:22:02   amaurya
 * Changes related to State machine optimization.
 * 
 *    Rev 1.24.1.1   22 Apr 2013 11:32:30   amaurya
 * Fixed tracker issue of Ver2.0S
 * 
 *    Rev 1.24.1.0   20 Mar 2013 09:39:26   ygupta
 * RF Switch Changes, Requirement Changes
 * 
 *    Rev 1.25   20 Mar 2013 08:19:24   ygupta
 * RF Switch Changes, Requirement Changes
 * 
 *    Rev 1.24   15 Mar 2013 10:53:22   ygupta
 * Issues Resolved, Requirement Changes
 * 
 *    Rev 1.23   11 Mar 2013 02:29:52   ygupta
 * Issues Fixed & Requirement Changes
 * 
 *    Rev 1.22   18 Feb 2013 03:11:34   ygupta
 * FieldBus Changes
 * 
 *    Rev 1.21   29 Jan 2013 02:24:06   ygupta
 * WebPages CleanUp, Code Review and CleanUp
 * 
 *    Rev 1.20   22 Jan 2013 10:38:36   ygupta
 * Profibus Bug Fixes
 * 
 *    Rev 1.19   17 Jan 2013 07:26:28   ygupta
 * Profibus Related changes
 * 
 *    Rev 1.18   16 Jan 2013 06:30:24   ygupta
 * Level2 Code with Profibus
 * 
 *    Rev 1.17   11 Jan 2013 02:55:12   ygupta
 * Level2 Requirement Changes
 * 
 *    Rev 1.16   27 Dec 2012 06:45:52   ygupta
 * Changes to fix Issues
 * 
 *    Rev 1.15   18 Dec 2012 07:39:08   ygupta
 * Changes for Multiple Overload alarm in case of 15V lost
 * 
 *    Rev 1.13   14 Dec 2012 05:29:08   ygupta
 * Alarms Implemented
 * 
 *    Rev 1.12   13 Dec 2012 00:13:10   ygupta
 * Changes related to Issues
 * 
 *    Rev 1.11   29 Nov 2012 08:48:44   rjamloki
 * Scan Changes and Coverty issues Resolved
 * 
 *    Rev 1.10   24 Nov 2012 08:05:42   amaurya
 * Added changes for 40KHz supply.
 * 
 *    Rev 1.9   08 Nov 2012 01:21:50   rjamloki
 * Website changes
 * 
 *    Rev 1.8   05 Nov 2012 09:00:00   amaurya
 * State Machine changes
 * 
 *    Rev 1.7   29 Oct 2012 02:56:32   rjamloki
 * Printfs disbaled and changes in website
 * 
 *    Rev 1.6   26 Oct 2012 02:40:48   rjamloki
 * Website Related files Added
 * 
 *    Rev 1.4   21 Sep 2012 01:34:40   rjamloki
 * Added State machine
 * 
 *    Rev 1.3   11 Sep 2012 10:12:28   rjamloki
 * User IO update and clean up
 * 
 *    Rev 1.2   29 Aug 2012 13:28:10   rjamloki
 ...
 * 
 *    Rev 1.0   21 Jun 2012 12:38:24   ygupta
 * Initial revision.
...
static BOOLEAN ReadyFlg, SonicsActive, GenAlarm, StatusFlag, CycleOK, PresetChanged, AmplitudeDecay,
...
DIGITALIOMAP  OutPtr[NUM_FUNC_OUT + 1] = {
   ...
   {0,		          			 LOW,	   (ALL)},  /* 0  Not used    */
	...
	{&AmplitudeDecay,	 		    HIGH,	(ALL)},/* 11AmplitudeDecay active high */
	{&AmplitudeDecay,	 		    LOW,	   (ALL)},/* 12AmplitudeDecay active low */
...
void UserIO::InitUserIO(void)
{
   ...
   //Allocate object of DAC device to access DAC chip and assign to class variable
	...
	DAC = new TLV5604(Board::GetSPI(0, 5, 5), DSPICSPIN_DAC, REFVOLTAGE_DAC, REFVOLTAGE_DAC);
	//Allocate object of ADC device to access  ADC chip and assign to class  //variable
	ADC = new MCP3208(Board::GetSPI(0, 5, 5), DSPICSPIN_ADC, REFVOLTAGE_ADC);
...
/* void UserIO::SetAmlitudeDecay(BOOLEAN State)
*
*  Purpose
*  Set or clear AmplitudeDecay flag. This function is called by WC State machine
* 	to set the flag if Amplitude value reaches below 3 percent.
*
*  Entry condition
*	State: The value to be assigned to AmplitudeDecay flag.
*
*  Exit condition
*
*/
