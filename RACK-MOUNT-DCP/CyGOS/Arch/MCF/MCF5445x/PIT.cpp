// $Header:   D:/databases/VMdb/archives/DCX/RackMount/DCP/CyGOS/Arch/MCF/MCF5445x/PIT.cpp_v   1.0   18 Aug 2014 09:15:38   amaurya  $
//
...
void PIT::Remove(int channel)
{
	...
	{
	case 0:
		CPU::SetupDefaultHandler(Exception::DefaultHandler, intPIT0, 1, 1,
				256);
		break;
	case 1:
		CPU::SetupDefaultHandler(Exception::DefaultHandler, intPIT1, 1, 1,
				256);
		break;
	case 2:
		CPU::SetupDefaultHandler(Exception::DefaultHandler, intPIT2, 1, 1,
				256);
		break;
	case 3:
		CPU::SetupDefaultHandler(Exception::DefaultHandler, intPIT3, 1, 1,
				256);
		break;
	}
}
