// $Header:   D:/databases/VMdb/archives/DCX/RackMount/DCP/CyGOS/Arch/MCF/MCF5445x/CPU.cpp_v   1.0   18 Aug 2014 09:15:30   amaurya  $
//
...
{
	rtosPit = new PIT(0, usec * __SYSTEM_CLOCK, 6, 1, handler, stackSize);
}
