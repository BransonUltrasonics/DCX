// $Header:   D:/databases/VMdb/archives/DCX/RackMount/DCP/CyGOS/Arch/MCF/MCF5445x/DCPRM/LED.cpp_v   1.0   18 Aug 2014 09:15:42   amaurya  $
//
...
void LED::Init()
{
	...
	MMU::Map((int) lptr);
	CPU::SetupChipSelect(2, 20, 8, lptr);
	*lptr = 0xFF;
}
