// $Header:   D:/databases/VMdb/archives/DCX/RackMount/DCP/CyGOS/Arch/MCF/MCF5445x/Exception.h_v   1.1   28 Jan 2015 05:46:36   sesharma  $
//
...
public:
	...
	static void SetDefault(int vector, ExceptionHandler, int stackSize);
protected:
