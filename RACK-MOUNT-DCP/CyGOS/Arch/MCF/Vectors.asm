| $Header:   D:/databases/VMdb/archives/DCX/RackMount/DCP/CyGOS/Arch/MCF/Vectors.asm_v   1.2   16 Oct 2014 03:53:28   sesharma  $
|
...
_cache_flush:
				movec	%D7, %CACR			| Set bits 14,20,28,12 as 1010 for
											| CPUSHL Enhancements
				cpushl	%bc, (%A0)			| Push data, clear instruction cache
