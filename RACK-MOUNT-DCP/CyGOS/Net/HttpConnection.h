// $Header:   D:/databases/VMdb/archives/DCX/RackMount/DCP/CyGOS/Net/HttpConnection.h_v   1.1   20 Nov 2015 01:58:02   sesharma  $
//
...
#define ERR_STR_FIRMWAREUPLOAD "Uploaded file not accepted by server. "		//"Programming Error. Try again. "
