// $Header:   D:/databases/VMdb/archives/DCX/RackMount/DCP/CyGOS/stdlib/Alloc.cpp_v   1.0   18 Aug 2014 09:16:46   amaurya  $
//
...
//	CheckMemory("Before Malloc\n");
	...
	if (!header)
	{
		...
		CyGOS::WriteSystemEvent(ALLOCATION_ERROR, line ,((fname[4] << 24) | (fname[5] << 16) | (fname[6] << 8) | fname[7]),
