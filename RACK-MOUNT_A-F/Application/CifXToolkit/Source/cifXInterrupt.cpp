...
//               TRACE_LEVEL_ERROR,
//	  pprintf("cifXTKitISRHandler() : We received an interrupt, but IRQs are disabled!");
...
//        pprintf("\nI0 %08X %d\n", ptDevInstance->pbHandshakeBlock, sizeof(*ptHandshakeBuffer));
      } else
      {
...
//        	  pprintf("D4 ");
      ...
      do
      {
        ...
        uint32_t ulIdx;
//        pprintf("D5_%d ", ptChannel->ulBlockID);
...
//        pprintf("\n Bits oldNetx=%04X newNetx=%04X changeBits=%04X uneqBits=%04X", usOldNetxFlags,ptChannel->usNetxFlags, usChangedBits, usUnequalBits);
        /*------------------------------------------*/
...
//              pprintf("D11 ");
        ...
        {
//        	pprintf("D12_1");
//        	pprintf(" mbcb %08X", ptChannel->tSendMbx.pfnCallback);
...
//            pprintf("D12_2 ");
        ...
        {
//        	pprintf(" mbrecv %08X %08X", ptChannel->tRecvMbx.pfnCallback, ptChannel);
