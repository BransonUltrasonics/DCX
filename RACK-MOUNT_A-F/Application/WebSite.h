/*
$Header:   D:/databases/VMdb/archives/DCX/RackMount/A&F/WC/Application/WebSite.h_v   1.1   24 Jul 2015 08:40:24   sesharma  $
*/
/****************************************************************************/
/*                                                                          */
/*                                                                          */
...
/*************************                         **************************/
/*****************************************************************************
$Log:   D:/databases/VMdb/archives/DCX/RackMount/A&F/WC/Application/WebSite.h_v  $
 * 
 *    Rev 1.1   24 Jul 2015 08:40:24   sesharma
 * Added declaration for ReadTarRegionFlash().
 * 
...
static const char * const FileUploadSuccessMsg =
		"<HTML><head><title>BRANSON DCX GUI</title></head>"
		"<BODY><div style=\"text-align:center;margin-top:150px\"></br></br>"
		"	<div style=\"font-size:18\">File Upload Successful!</div>"
		"	<div style=\"font-size:30;color:red\">Please allow <b>5</b> minutes for </br> system to reset itself. <u>Do not</u></br> remove power during this time.</div>"
		"	</br><div style=\"font-size:12\">Once system has been reset, you must reload your browser to re-access the web content.</div>"
		"</div></BODY>"
		"</HTML>";
#endif /*WEBSITE_H_*/
