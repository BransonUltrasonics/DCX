/*
$Header:   D:/databases/VMdb/archives/DCX/RackMount/A&F/WC/Application/ScanResDetect.cpp_v   1.1   03 Feb 2016 01:18:06   ygupta  $
*/
/****************************************************************************/
/*                                                                          */
/*                                                                          */
...
/*************************                         **************************/
/*****************************************************************************
$Log:   D:/databases/VMdb/archives/DCX/RackMount/A&F/WC/Application/ScanResDetect.cpp_v  $
 * 
 *    Rev 1.1   03 Feb 2016 01:18:06   ygupta
 * Fix for Passing horn scan when no resonance frequency is detected.
 * 
...
void FindResonanceInCluster(void)
{
   ...
   for(XaxisIndex = HS_HALFWINDOWSIZE; (XaxisIndex < (NumScanPoints - HS_HALFWINDOWSIZE)) && (ZaxisIndex < DCP_NUMRESONANCES); XaxisIndex++){
      ...
      if(YaxisIndex >= HS_CLUSTERPTS)      //Too many points, so force analysis.
