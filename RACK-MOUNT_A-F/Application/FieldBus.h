/*
$Header:   D:/databases/VMdb/archives/DCX/RackMount/A&F/WC/Application/FieldBus.h_v   1.5   18 Feb 2016 14:01:08   ygupta  $
*/
/****************************************************************************/
/*                                                                          */
/*                                                                          */
...
/*************************                         **************************/
/*****************************************************************************
$Log:   D:/databases/VMdb/archives/DCX/RackMount/A&F/WC/Application/FieldBus.h_v  $
 * 
 *    Rev 1.5   18 Feb 2016 14:01:08   ygupta
 * Added virtual function ProtocolSpecificPreInit()
 * 
 *    Rev 1.4   27 Aug 2015 11:02:46   RJamloki
 * Added an offset enum value in ParaType enum to get corresponding signed data type value.
 * 
 *    Rev 1.3   11 Aug 2015 05:33:02   RJamloki
 * Added define for Data1 value to be used for Fieldbus Error event in case of communication failure
 * 
 *    Rev 1.2   10 Aug 2015 09:39:44   RJamloki
 * Added wrapper function to check the memory clear command from fieldbus
 * 
 *    Rev 1.1   24 Jun 2015 08:35:48   amaurya
 * Added AskIPTimer for keeping track of time elapsed after Eth link up indication
 * 
...
//Below defines go into Data1 field to differentiate between Fieldbus error event logs.
#define CARD_DETECT_ERROR ((SINT32)1)
#define PROTOCOL_DETECT_ERROR ((SINT32)2)
#define APP_REGISTOR_ERROR ((SINT32)3)
#define WARMSTART_CONFIG_ERROR ((SINT32)4)
#define ADD_DEVICE_ERROR ((SINT32)5)
#define DRIVER_OPEN_ERROR ((SINT32)6)
#define CHANNEL_OPEN_ERROR ((SINT32)7)
#define SYSDEVICE_NOT_READY ((SINT32)8)
#define COMMCHANNEL_NOT_READY ((SINT32)9)
#define COMMUNICATION_ERROR ((SINT32)10)
...
#define SYSCONFIG_BASE          	   950
#define SYSCONFIG_LAST                 953
...
typedef enum
{
   ...
   TYPE_OFFSET_UNSIGNEDTOSIGNED = TYPE_A_32,//the offset to add on unsigned data types to get the corresponding signed data type enum value
...
public:
	...
	virtual void ProtocolSpecificPreInit(CIFXHANDLE HChannel);
