// $Header:   D:/databases/VMdb/archives/DCX/RackMount/A&F/WC/BootloaderApplication/SerialBootTask.cpp_v   1.0   24 Jul 2015 09:12:42   sesharma  $
//
...
void SerialBootTask::Run()
{
	...
	PrintPrompts();
	int iMax = 5;//Max retries in the interval of 50 ms to poll for Enter Key before bootloader jumps to application
	int ch;
...
void SerialBootTask::BurnImageToFlash()
{
	...
	if (!flash->Program(__USER_FLASH_ROM, bootImageBuffer, bootImageLength,ProgramCallback))
