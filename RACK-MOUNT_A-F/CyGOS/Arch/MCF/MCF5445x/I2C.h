// $Header:   D:/databases/VMdb/archives/DCX/RackMount/A&F/WC/CyGOS/Arch/MCF/MCF5445x/I2C.h_v   1.1   24 Jul 2015 08:58:20   sesharma  $
//
...
{
public:
	I2C(int instance, int address, int intLevel, int intPriority, int clk);
...
protected:
	...
	int GetClockDividerValue(int systemClock, int i2cClock);
	/**
