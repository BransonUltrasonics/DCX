// $Header:   D:/databases/VMdb/archives/DCX/RackMount/A&F/WC/CyGOS/Arch/MCF/MCF5445x/Exception.cpp_v   1.1   24 Jul 2015 08:58:18   sesharma  $
//
 ...
 * @param handler Function to handle the interrupt.
 */
void Exception::SetDefault(int vector, ExceptionHandler handler, int stackSize)
{
	ASSERT(ExceptionHandlerArray[vector] != DefaultHandler);
...
void Exception::DefaultHandler(int vector, void * frame)
{
	...
	//	pprintf("\n i = %d\n", i);
		...
		CyGOS::KickWatchDog();
	//TODO. 15.01.2015 MMUAR HAVE TO CHECK
		MMUAR = 0;
	}
