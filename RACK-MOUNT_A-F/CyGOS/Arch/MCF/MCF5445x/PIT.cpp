// $Header:   D:/databases/VMdb/archives/DCX/RackMount/A&F/WC/CyGOS/Arch/MCF/MCF5445x/PIT.cpp_v   1.1   24 Jul 2015 08:58:20   sesharma  $
//
...
void PIT::Remove(int channel)
{
	...
	{
		case 0:
			CPU::SetupDefaultHandler(Exception::DefaultHandler, intPIT0, 1, 1,256);
			break;
		case 1:
			CPU::SetupDefaultHandler(Exception::DefaultHandler, intPIT1, 1, 1,256);
			break;
		case 2:
			CPU::SetupDefaultHandler(Exception::DefaultHandler, intPIT2, 1, 1,256);
			break;
		case 3:
			CPU::SetupDefaultHandler(Exception::DefaultHandler, intPIT3, 1, 1,256);
			break;
	}
}
