// $Header:   D:/databases/VMdb/archives/DCX/RackMount/A&F/WC/CyGOS/Net/HttpServer.h_v   1.1   24 Jul 2015 08:51:06   sesharma  $
//
...
struct UploadSupportedFile
{
	...
	char * extension;//type of file
};

struct SendBackUploadData
{
	char * HtmlFormAction;
	char * SendBackFileName;
};
...
#define ERR_STR_FILEEXTENSION "File Of this type not supported for Upload. "
#define ERR_STR_FILEUPLOADED "File has been uploaded. Wait for System to restart. "
#define ERR_STR_FILEUPLOADFAIL "Uploaded File Rejected. Try again. "
#define ERR_FILE_START "File Start not found. "
#define ERR_FILENAME_LEN "File name is too big. "
...
public:
	...
	void AddToUploadSupportList(char * ext , int MaxUploadSize);
	void AddToSendBackUploadDataList(char * FormAction, char * SendBackFileName);//TODO:Give better names
	PtrList<UploadSupportedFile> UploadSupportedList;
	PtrList<SendBackUploadData>  SendBackUploadList;
	int GetMaxUploadLength();
	...
	void SetResourceUnAvailableMsg(char * Msg);
	void SetFileLenInvalidMsg(char * Msg);
	void SetFileExtensionInvalidMsg(char * Msg);
	void SetFileUploadSuccessMsg(char * Msg);
	void SetFileUploadRejectMsg(char * Msg);
	//TODO:Public interface with public members!!
	char * ResourceUnavailableMsg,
			 * FileLenInvalidMsg,
			 * FileExtensionInvalidMsg,
			 * FileUploadSuccessMsg,
			 * FileUploadRejectMsg,
			 * FileUploadInvalidStartMsg,
			 * FileUploadInvalidFileNameMsg;
protected:
