/*
$Header:   D:/databases/VMdb/archives/DCX/DCP/DCP Application/DCX2010/WelderSearchTask.cpp_v   1.5.1.0.1.1   Feb 09 2017 15:32:58   hasanchez  $
*/
/****************************************************************************/
/*                                                                          */
/*                                                                          */
...
/*************************                         **************************/
/*****************************************************************************
$Log:   D:/databases/VMdb/archives/DCX/DCP/DCP Application/DCX2010/WelderSearchTask.cpp_v  $
 * 
 *    Rev 1.5.1.0.1.1   Feb 09 2017 15:32:58   hasanchez
 * Set the WRSendflag to false if missconnection 
 * 
 *    Rev 1.5.1.0.1.0   17 Mar 2016 16:23:58   hasanchez
 * Added the changes to the function Adjust Stack
 * 
 *    Rev 1.5.1.1   17 Mar 2016 16:07:34   hasanchez
 * Added the changes to include the function Adjust amplitude.
 * 
 *    Rev 1.5.1.0   13 Feb 2013 09:23:36   amaurya
 * Added Graphs, Energy special and rescaling special.
 * 
 *    Rev 1.6   15 Jan 2013 04:44:50   amaurya
 * Energy Special.
 * 
...
WelderSearchTask::WelderSearchTask(int intf):Task("welder Search", WELDERSEARCHTASK_STACKSIZE),msgQ(10 , "msgQ")
{
...
void WelderSearchTask::AddWelderInfo(WelderInfoParam info)
{
	...
	if(newWelderFound)
	{
		...
		memcpy(wldrInfo->WelderInfo.SeriallNumber, info.WelderInfo.SeriallNumber, SIZE_SERAILNUMBER);
...
void WelderSearchTask::BroadcastwelderInfo()
{
	...
	sendto(fd, &msg.WelderInfo, sizeof(msg.WelderInfo), 0, (sockaddr *) &sa, sizeof(sa));
}
