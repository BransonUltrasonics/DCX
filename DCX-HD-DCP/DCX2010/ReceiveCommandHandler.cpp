/*
$Header:   D:/databases/VMdb/archives/DCX/DCP/DCP Application/DCX2010/ReceiveCommandHandler.cpp_v   1.13.1.15.1.1   Jul 07 2017 12:34:48   hasanchez  $
*/
/****************************************************************************/
/*                                                                          */
/*                                                                          */
 ...
 * 
 *    Rev 1.13.1.15.1.1   Jul 07 2017 12:34:48   hasanchez
 * Update to make the code more readable
 * 
 *    Rev 1.13.1.15.1.0   17 Mar 2016 16:23:44   hasanchez
 * Added the changes to the function Adjust Stack
 * 
 *    Rev 1.13.1.16   17 Mar 2016 16:07:22   hasanchez
 * Added the changes to include the function Adjust amplitude.
 * 
 *    Rev 1.13.1.15   02 Sep 2014 07:00:32   amaurya
 * Changed for Digital Tune.
 * 
 *    Rev 1.13.1.14   13 Feb 2013 09:20:30   amaurya
...
/****************************************************************************/
{
	...
	//Convert MemoryFreq
	MemoryFreqLCD = (((CurrentPreset.MemoryFreq + CurrentPreset.DigitalTune)* F_Factor)/1000);
...
//	UINT16 Regaddr;
	...
	cmd.data[DataByteCount++] = MemoryFreqLCD >> 8;
	cmd.data[DataByteCount++] = MemoryFreqLCD;
...
/****************************************************************************/
{
	...
	switch(dataReg)
	{
		...
		case regAmplitude:
		PresetUpdate = TRUE;
			CurrentPreset.WeldAmplitude = CurrentPreset.HDParam.InitPara[HD_WELD_AMPLITUDE ] = value;
