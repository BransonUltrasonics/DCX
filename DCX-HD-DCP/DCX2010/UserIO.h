/*
$Header:   D:/databases/VMdb/archives/DCX/DCP/DCP Application/DCX2010/UserIO.h_v   1.10.1.2.1.3   Aug 14 2018 12:17:10   EGUAJARDO  $
*/
/****************************************************************************/
/*                                                                          */
/*                                                                          */
 ...
 * 
 *    Rev 1.10.1.2.1.3   Aug 14 2018 12:17:10   EGUAJARDO
 * Added MAXVOLTAGE_DAC_OUT.
 * 
 *    Rev 1.10.1.2.1.1   Jan 03 2017 16:11:20   hasanchez
 * Added new option to Analog outputs.
 * 
 *    Rev 1.10.1.2.1.0   17 Mar 2016 16:23:48   hasanchez
 * Added the changes to the function Adjust Stack
 * 
 *    Rev 1.10.1.3   17 Mar 2016 16:07:26   hasanchez
 * Added the changes to include the function Adjust amplitude.
 * 
 *    Rev 1.10.1.2   10 Mar 2015 07:53:00   amaurya
 * Add feature “energy in range 250J" on the analog inputs.
 * 
 *    Rev 1.10.1.1   02 Jul 2014 09:40:16   amaurya
 * Removed Amplitude Decay function.
 * 
 *    Rev 1.10.1.0   13 Feb 2013 09:22:20   amaurya
...
#define	NUM_FUNC_IN	38		// # of input functions defined in PRS
...
#define	NUM_FUNC_AOUT	20		// # of output functions defined in PRS
...
#define MAXVOLTAGE_DAC_OUT	5000 //5000mv
...
enum USERDEFINED_ANALOGOUTPUTFUNC
{
	...
	POWER_OUT4500W,//417:S,Power Out-4500 Watts
};
...
public:
	...
	static BOOLEAN CheckForPWMAmpAdjust_Input(void);
	...
	static void SetOutputCurrent(SINT32 val);
